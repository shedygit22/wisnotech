...
const pages = {
  masterclass: {
    ...
    paymentMethods: [
      { label: "For Africa", provider: "Paystack", url: "https://paystack.shop/pay/96toe5qx8t", image: "/assets/paystack-banner.png", currency: "NGN", price: 100000 },
      { label: "International", provider: "Selar", url: "https://selar.com/1zbx702773", image: "/assets/selar-banner.png", currency: "USD", price: 74.28 },
    ],
    faqs: [
