...
export const PORTFOLIO_SAMPLES: PortfolioSample[] = [
  ...
  },
  {
    ...
    type: "video",
    title: "Dune Trailer",
    description: "Cinematic sci-fi trailer with epic scale and atmospheric pacing.",
    category: "film",
  ...
  },
  {
    ...
    type: "video",
    title: "Fitness Vlog",
    description: "Energetic gym vlog with punchy cuts and motivational energy.",
    category: "social-media",
  ...
  },
  {
    id: "p22",
    type: "video",
    title: "Portrait Loop 01",
    description: "Vertical portrait loop built for social feeds.",
    category: "social-media",
    ...
    height: 1138,
    durationSeconds: 15,
    tags: ["portrait", "loop", "9:16"],
    published: true,
  },
  {
    id: "p23",
    type: "video",
    title: "Portrait Loop 02",
    description: "Vertical portrait loop built for social feeds.",
    category: "social-media",
  ...
  },
  {
    ...
    type: "video",
    title: "Web Demo",
    description: "16:9 web-ready demo loop generated from a single prompt.",
    category: "cinematic",
