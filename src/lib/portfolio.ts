...
export const PORTFOLIO_SAMPLES: PortfolioSample[] = [
  ...
  },
  {
    id: "p22",
    type: "video",
    title: "Portrait Scene 01",
    description: "Vertical portrait scene crafted for social feeds.",
    category: "social-media",
  ...
  },
  {
    ...
    type: "video",
    title: "Wide Demo",
    description: "Cinematic 16:9 generation from a single prompt.",
    category: "cinematic",
